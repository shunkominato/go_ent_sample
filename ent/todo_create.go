...
func (tc *TodoCreate) SetTodoStatusesID(i int) *TodoCreate {
	tc.mutation.SetTodoStatusesID(i)
	return tc
}

// SetNillableTodoStatusesID sets the "todo_statuses_id" field if the given value is not nil.
func (tc *TodoCreate) SetNillableTodoStatusesID(i *int) *TodoCreate {
	if i != nil {
		tc.SetTodoStatusesID(*i)
	}
	return tc
}
...
func (tc *TodoCreate) SetTodoStatuID(id int) *TodoCreate {
	tc.mutation.SetTodoStatuID(id)
	return tc
}

// SetNillableTodoStatuID sets the "todo_statu" edge to the TodoStatus entity by ID if the given value is not nil.
func (tc *TodoCreate) SetNillableTodoStatuID(id *int) *TodoCreate {
	if id != nil {
		tc = tc.SetTodoStatuID(*id)
	}
	return tc
}

// SetTodoStatu sets the "todo_statu" edge to the TodoStatus entity.
func (tc *TodoCreate) SetTodoStatu(t *TodoStatus) *TodoCreate {
	return tc.SetTodoStatuID(t.ID)
}
...
func (tc *TodoCreate) createSpec() (*Todo, *sqlgraph.CreateSpec) {
	...
	if nodes := tc.mutation.TodoStatuIDs(); len(nodes) > 0 {
